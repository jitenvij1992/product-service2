...
public class ProductReviewServiceImpl implements ProductReviewService {
    ...
    @Autowired
    public ProductReviewServiceImpl(RestTemplate restTemplate) {
    ...
    public ResponseEntity<Review> create(long id, ReviewDTO reviewDTO) {
        ...
        ResponseEntity<Review> responseEntity = restTemplate.exchange(Constants.HOSTNAME + id + Constants.SLASH + Constants.REVIEW, HttpMethod.POST, httpEntity, Review.class);
    ...
    public ResponseEntity delete(long productId, long reviewId) {
        ...
        int statusCode;
        try {
            ResponseEntity<String> responseEntity = restTemplate.exchange(Constants.HOSTNAME + productId + Constants.SLASH + Constants.REVIEW + Constants.SLASH + reviewId, HttpMethod.DELETE, HttpEntity.EMPTY, String.class);
    ...
    public ResponseEntity<String> put(long productId, long reviewId, ReviewDTO payload) {
        ...
        int statusCode;
        try {
            ResponseEntity<String> responseEntity = restTemplate.exchange(Constants.HOSTNAME + productId + Constants.SLASH + Constants.REVIEW + Constants.SLASH + reviewId, HttpMethod.PUT, httpEntity, String.class);
    ...
    public ResponseEntity<List> get(long productId) {
        return restTemplate.getForEntity(Constants.HOSTNAME + productId + Constants.SLASH + Constants.REVIEW, List.class);
    }
